...
def make_initial_rounds_table(session,constants):
    ...
    full_capacity_permit_demand = [(constants.production_capacity_high*constants.emission_intensity_high) + 
                                (constants.production_capacity_low*constants.emission_intensity_low)]*num_rounds
