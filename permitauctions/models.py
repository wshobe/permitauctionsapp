...
from .generate_random_costs import costs1, generate_output_prices
...
class Constants(BaseConstants):
    ...
    num_rounds = 10  # !!! Make sure this matches the num_rounds in settings.py
...
class Player(BasePlayer):
    ...
    production_amount = models.PositiveIntegerField(min=Constants.must_run, max=4, choices=range(Constants.must_run, 5))
